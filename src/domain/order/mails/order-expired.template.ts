...
<head>
    ...
    <title>Pedido não finalizado</title>
</head>
<body
    ...
    <div>
        ...
        <div style="max-width:800px; margin:auto;">
            ...
            <table style="max-width: 600px; margin: auto; width: 100%;padding:0px 0px 48px 0px;color: #E7ECE6;">
                <tr>
                    <td>
                        <h1 style="font-weight: 600; font-size: 30px; line-height: 40px;margin: 0;color: #95DE81;">O pagamento do pedido abaixo não foi identificado:<h1>
                    </td>
                </tr>
            </table>
            <!-- TABLE / RECEIPT -->
                ...
                <tr>
                    <td>
                        <h2
                            ...
                            ID PIX: {{endToEndId}}</h2>
                    </td>
                </tr>
            </table>
            <table
                style="max-width: 500px; margin: 0 auto; width: 100%;background-color: #13250E; padding: 8px 40px 24px 40px;border-radius: 0px 0px 8px 8px;">
                <tr>
                    <td style="width:40%;">
                        <p
            ...
            <!-- CONTACT -->
            <table
                style="max-width: 600px; margin: auto; width: 100%;padding: 0px 0px 70px 0px; color: #FAFAFA;text-align: center;">
                <tr>
                    <td>
                        <p style="font-weight: 200; font-size: 16px;  line-height: 28px;margin: 16px 0px 0px 0px;">                        <span
                            style="font-weight: 400; font-size: 14px;line-height: 20px;color: #091A04;background-color: #2BBD04;border-radius: 10px;padding: 0px 12px;width: fit-content; text-align: center;">
                            Browser:</span> <small>{{clientAgent}}</small></p>
                    </td>
                </tr>
            </table>
        </div>
