...
import { type FetchableKnnBasisPort } from '../../../../domain/price/ports/fetchable-knn-basis.port';
import { type FetchableUsdBasisPort } from '../../../../domain/price/ports/fetchable-usd-basis.port';
import { type CurrencyAmount } from '../../../../domain/price/value-objects/currency-amount.value-object';

import { type KnnQuoteBasis } from '../../../../domain/price/value-objects/knn-quote-basis.value-object';
...
export class FetchableKnnBasisMBHttpAdapter implements FetchableKnnBasisPort {
  ...
  static cachedBasis: KnnQuoteBasis | undefined;
  ...
  static getCachedBasis(): KnnQuoteBasis | undefined {
    if (
  ...
  async fetch(forceReload = false): Promise<KnnQuoteBasis> {
