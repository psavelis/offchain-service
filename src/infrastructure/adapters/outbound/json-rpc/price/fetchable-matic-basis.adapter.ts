...
import { IChainlinkProtocolProvider } from '../polygon-chainlink.provider';
import { MaticQuoteBasis } from '../../../../../domain/price/value-objects/matic-quote-basis.value-object';
import { FetchableMaticBasisPort } from '../../../../../domain/price/ports/fetchable-matic-basis.port';
  ...
  implements FetchableMaticBasisPort
{
  ...
  async fetch(forceReload: boolean = false): Promise<MaticQuoteBasis> {
