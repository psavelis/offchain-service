...
export interface KannaTokenInterface extends utils.Interface {
  functions: {
    ...
    "initializeTreasury(address)": FunctionFragment;
...
export interface TreasuryUpdateEventObject {
  sender: string;
  fromTreasury: string;
  newTreasury: string;
}
export type TreasuryUpdateEvent = TypedEvent<
  [string, string, string],
  TreasuryUpdateEventObject
>;

export type TreasuryUpdateEventFilter = TypedEventFilter<TreasuryUpdateEvent>;

export interface KannaToken extends BaseContract {
  ...
  filters: {
    ...
    "TreasuryUpdate(address,address,address)"(
      sender?: PromiseOrValue<string> | null,
      fromTreasury?: PromiseOrValue<string> | null,
      newTreasury?: null
    ): TreasuryUpdateEventFilter;
    TreasuryUpdate(
      sender?: PromiseOrValue<string> | null,
      fromTreasury?: PromiseOrValue<string> | null,
      newTreasury?: null
