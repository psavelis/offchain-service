...
export interface KnnHolderBadgeCheckerInterface extends utils.Interface {
  functions: {
...
export interface KnnHolderBadgeChecker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KnnHolderBadgeCheckerInterface;
