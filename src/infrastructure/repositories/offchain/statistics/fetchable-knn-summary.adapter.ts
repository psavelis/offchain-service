...
import {type KnnSummaryDto} from '../../../../domain/statistics/dtos/knn-summary.dto';
import {type FetchableKnnSummaryPort} from '../../../../domain/statistics/ports/fetchable-knn-summary.port';
...
export class FetchableKnnSummaryDbAdapter implements FetchableKnnSummaryPort {
  ...
  async fetch(): Promise<KnnSummaryDto> {
